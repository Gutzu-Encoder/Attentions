# Attentions
repo นี้มีไว้เพื่อเป็นการทบทวนเรื่อง Attention ส่วนตัวของผู้เขียนซึ่งไม่ได้หมายถึงเเค่ scale-dot product attention เเต่จะพูดถึง variation ต่างๆของการประยุกต์ใช้ attention เช่น
